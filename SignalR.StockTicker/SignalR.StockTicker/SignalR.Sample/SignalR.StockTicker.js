...
$(function () {
    var ticker = $.connection.stockTickerHub, // the generated client-side hub proxy, camelCase class name
    //var ticker = $.connection.stockTicker, // the generated client-side hub proxy when using a HubName attribute
        up = '▲',
        down = '▼',
